...
#include "stanExports_epidemia_pp_base.h"

RCPP_MODULE(stan_fit4epidemia_pp_base_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_epidemia_pp_base")
